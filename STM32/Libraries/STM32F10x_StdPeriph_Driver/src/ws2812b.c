...
void ws2812bSet(const int index, int32_t color)
{
    int32_t i, j;
    int32_t k = 0;
...
void ws2812bSet_RGB(const int index, uint32_t red, uint32_t green, uint32_t blue)
{
...
{
	uint32_t green = color & 0xff0000;
	uint32_t red = color & 0x00ff00;
